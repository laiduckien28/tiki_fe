...
const SignUpComponent = () => {
  ...
  // const data_raw = mutation.data.data.message;
  ...
  return (
    <div className="relative" >
      {/* {mutation.isLoading && (
        <div className="absolute top-0 left-0 w-full h-full bg-white bg-opacity-70 z-50 flex items-center justify-center">
